...
export function GatewaySection() {
  ...
  return (
    <section id="gateway" className="py-32 relative bg-background min-h-[900px] flex items-center z-[20]">
      <AnimatePresence>
        {transitioning === "code" && (
      ...
      <div className="absolute inset-0 pointer-events-none z-[60] select-none">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          animate={{
            x: hoveredSide === "creative" ? 80 : 0,
            scale: hoveredSide === "creative" ? 1.05 : 1,
            filter: hoveredSide === "creative" ? "grayscale(0) brightness(1.1)" : "grayscale(0.2) brightness(0.8)"
          }}
          transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
          className="absolute -top-48 bottom-0 -left-32 md:-left-56 lg:-left-80 w-[45%] md:w-[35%] lg:w-[30%] pointer-events-none"
        >
          <img
            src="/assets/kat beyond the code.png"
            alt="Beyond Code"
            className="w-full h-full object-contain object-left scale-[1.4] md:scale-[1.8] origin-left transition-all duration-700"
          />
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          animate={{
            x: hoveredSide === "code" ? -80 : 0,
            scale: hoveredSide === "code" ? 1.05 : 1,
            filter: hoveredSide === "code" ? "grayscale(0) brightness(1.1)" : "grayscale(0.2) brightness(0.8)"
          }}
          transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
          className="absolute -top-48 bottom-0 -right-32 md:-right-56 lg:-right-80 w-[45%] md:w-[35%] lg:w-[30%] pointer-events-none"
        >
          <img
            src="/assets/kat in code.png"
            alt="In Code"
            className="w-full h-full object-contain object-right scale-[1.4] md:scale-[1.8] origin-right transition-all duration-700"
          />
        </motion.div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row min-h-[700px] items-center justify-between gap-12 lg:gap-32">
          ...
          >
            <div className="flex flex-col items-center lg:items-end text-center lg:text-right max-w-lg">
              ...
              <h2 className="text-6xl md:text-8xl xl:text-9xl font-display font-black tracking-tighter mb-6 group-hover:text-primary-gradient transition-all duration-500 uppercase leading-[0.8] text-foreground dark:text-white">
                BEYOND<br />CODE
              </h2>
              <p className="text-muted-foreground text-xl mb-10 font-medium max-w-sm">
              ...
              <div className="flex flex-col gap-6 items-center lg:items-end">
                ...
                <span className="text-[10px] font-black tracking-[0.3em] text-muted-foreground/60 flex items-center gap-3 uppercase">
